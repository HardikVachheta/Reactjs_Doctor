    ...
    return (
        <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul className="menu-inner py-1">
                {/* Dashboard */}
                <li className={`menu-item ${isActive('/dashboard_a_main') ? 'active' : ''}`}>
                    <Link to="/dashboard_a_main" className="menu-link">
                ...
                {/* Profile */}
                <li className={`menu-item ${isActive('/AdminProfile') ? 'active' : ''}`}>
                ...
                {/* Doctors */}
                <li className={`menu-item ${isActive('/All_Doctor') ? 'active' : ''}`}>
                    <Link to="/All_Doctor" className="menu-link">
